...
public class HomeController {
	...
	public ModelAndView logout(HttpServletRequest request) {
		...
		request.getSession().removeAttribute("usuario_autenticado"); //removendo este atributo em especifico da sessão
		request.getSession().invalidate(); //removendo tudo que estiver dentro da sessão
